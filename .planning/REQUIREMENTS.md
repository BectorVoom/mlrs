...
- [x] **PRIM-05**: An SVD / eigendecomposition primitive (GPU Jacobi or equivalent) serves PCA, TruncatedSVD, and the OLS/Ridge SVD solver paths, validated against an oracle within tolerance
